  ...
  <div>
    <div class="topgrid">
      <div>
        ...
        <h1 id="tagline">
          We are a church committed to serving the English-speaking community in
          Jakarta.
        </h1>
      </div>
    </div>
    <div class="innercolumns">
      <div class="item1">
        ...
        >
          <svg viewBox="0 0 30 30" width="40" height="auto">
            <path
              fill="#ffffff"
...
.grid-container {
  display: grid;
  grid-template-columns: minmax(min-content, 680px);
  justify-content: center;
  grid-gap: 16px;
  background-color: #3d3b3c;
}
